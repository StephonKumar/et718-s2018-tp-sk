...
class BoatcommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boatcomment" do
    assert_difference('Boatcomment.count') do
      post boatcomments_url, params: { boatcomment: { boat: @boatcomment.boat, comment: @boatcomment.comment, user: @boatcomment.user } }
    end
  ...
  test "should update boatcomment" do
    patch boatcomment_url(@boatcomment), params: { boatcomment: { boat: @boatcomment.boat, comment: @boatcomment.comment, user: @boatcomment.user } }
